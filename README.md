...
Linuxcoin is an experimental digital currency that enables instant payments to
anyone, anywhere in the world. Linuxcoin uses peer-to-peer technology to operate
with no central authority: managing transactions and issuing money are carried
out collectively by the network. Linuxcoin Core is the name of open source
...
Linuxcoin Core is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
Translations are converted to Linuxcoin periodically.
