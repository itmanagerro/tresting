...
{
    const char* pszTimestamp = "The Linux Foundation 31/Aug/2017 Open collaboration powers everything.";
...
*/
        ...
        vSeeds.push_back(CDNSSeedData("linuxcointools.com", "23.254.115.75"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("linuxcointools.com", "testnet-seed.linuxcointools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.linuxcoin.loshan.co.uk", true));
