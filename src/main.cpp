...
#if defined(NDEBUG)
# error "Linuxcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Linuxcoin Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s LNX additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("linuxcoin-scriptch");
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, const Consensus::Params& consensusParams, CBlockIndex * const pindexPrev, int64_t nAdjustedTime)
{
    ...
    // Linuxcoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Linuxcoin: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
