...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s linuxcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  linuxcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded linuxcoin transaction") + "\n" +
              "  linuxcoin-tx [options] -create [commands]   " + _("Create hex-encoded linuxcoin transaction") + "\n" +
              "\n";
