...
void Shutdown()
{
    ...
    RenameThread("linuxcoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/linuxcoin-project/linuxcoin>";
    const std::string URL_WEBSITE = "<https://linuxcoin.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("linuxcoin-loadblk");
    CImportingNow imp;
